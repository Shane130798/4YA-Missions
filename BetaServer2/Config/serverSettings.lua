...
{
    ["current"] = 1,
    ["description"] = "[4YA] TRAINING 24/7 - FOW BETA (CAPTURE BASES) \
\
...
CarrierOps ",
    ...
    ["missionList"] = 
    {
	   [1] = "C:\\Users\\Administrator\\Saved Games\\BetaServer2\\Missions\\4YA_Capture_Bases_Full_War_V35C.miz",

    }, -- end of ["missionList"]
    ["name"] = "[4YA] TRAINING 24/7 - FOW BETA (CAPTURE BASES)",
    ["listShuffle"] = false,
    ["listLoop"] = true,

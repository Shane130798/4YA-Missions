...
{
    ["current"] = 1,
    ["description"] = "[4YA] TRAINING 24/7 PERSIAN GULF PVE BETA US SERVER\
\
...
CarrierOps ",
    ...
    ["missionList"] = 
    {
        [1] = "C:\\Users\\Administrator\\Saved Games\\BetaServer2\\Missions\\4YA_Capture_Bases_Persian_Large_v28S.miz",
        [2] = "C:\\Users\\Administrator\\Saved Games\\BetaServer2\\Missions\\4YA_Capture_Bases_Persian_Large_v28B.miz",
    }, -- end of ["missionList"]
    ["password"] = "",
    ["listShuffle"] = false,
    ["name"] = "[4YA] TRAINING 24/7 PERSIAN GULF PVE BETA US SERVER",
    ["listLoop"] = true,
    ["uri"] = "startServer",

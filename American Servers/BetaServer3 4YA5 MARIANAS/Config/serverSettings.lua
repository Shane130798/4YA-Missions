cfg = 
{
    ["description"] = "[4YA] TRAINING 24/7 - MARIANAS (CAPTURE BASES) PVE BETA US SERVER\
\
...
CarrierOps ",
    ...
    ["password"] = "",
    ["listShuffle"] = false,
    ["name"] = "[4YA] TRAINING 24/7 - MARIANAS (CAPTURE BASES) PVE BETA US SERVER",
    ["listLoop"] = true,
    ["missionList"] = 
    {
        [1] = "C:\\Users\\Administrator\\Saved Games\\BetaServer3\\Missions\\4YA_Marianas_LS_V.1.7.miz",
    }, -- end of ["missionList"]

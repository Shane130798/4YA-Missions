    ...
    elseif _event.id == world.event.S_EVENT_TAKEOFF then
        ...
        local _unit = _event.initiator
         ...
         --   end
            ...
            -- warning
            local _groupId = dcsprotect.getGroupId(_unit)
            trigger.action.outTextForGroup(_groupId, "[4YA] SYRIA Full War: Short Mission Briefing** F10 MAP VIEW: ALLIES ONLY \n\ \n\-The objective is to coordinate attacks against the opposing team's bases and at the same time actively defend all friendly bases from incoming attacks\n\ \n\-The team that controls all 8 bases in the end wins the war!\n\-All airports that needs to be captured/defended have markers on the F10 map (list in briefing). \n\-If the airport has no friendly ground units visible on the F10 map, then it is hostile! Same goes for Heliports/Farps. \n\ \n\-SRS main channel:305AM. Check the briefing for more info! Lalt + B\n\Banned weapons:" .. _list, 15, true)

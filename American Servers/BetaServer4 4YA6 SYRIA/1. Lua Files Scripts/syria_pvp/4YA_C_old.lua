...
ctld.pickupZones = {
    ...
    { "pickzone30", "blue", -1, "yes", 0 }, -- instead of a Zone Name you can also use the UNIT NAME of a ship
}
...
ctld.spawnableCrates = {
    ...
    ["Ground Forces"] = {
		...
		{ weight = 254, desc = "MLRS M270", unit = "MLRS M270", side = 2, cratesRequired = 2 },

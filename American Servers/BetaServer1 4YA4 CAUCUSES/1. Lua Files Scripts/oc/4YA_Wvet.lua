    ...
    elseif _event.id == world.event.S_EVENT_TAKEOFF then
        ...
        local _unit = _event.initiator
         ...
         --   end
            ...
            -- warning
            local _groupId = dcsprotect.getGroupId(_unit)
            trigger.action.outTextForGroup(_groupId, "[4YA] TRAINING PVE VETERAN: Short Mission Briefing** \n\ \n\All bases that has to be captured are marked on the F10 map, if no frienldy units visible, then the airport is hostile!\n\Server will restart when all bases are friendly. \n\ \n\Available: CTLD, CSAR, Lotatc, Planes & Heli mods, Roadbases & SRS \n\ \n\Comms menu -> F10 (Others) -> EWRS -> Requst Bogey Dope\n\Use radio menu & F10 to check tacans, waypoints, jtac and more\n\Join us on discord and please read the briefing for more info Lalt+B!\n\Banned weapons:" .. _list, 15, true)

cfg = {
	...
	['mode'] = 0,
	['name'] = '[4YA] TRAINING 24/7 CAUCUSES PVE BETA PVE STABLE (CAPTURE BASES) US SERVER',
	['password'] = '',
	['port'] = 10313,

    ...
    elseif _event.id == world.event.S_EVENT_TAKEOFF then
        ...
        local _unit = _event.initiator
         ...
         --   end
            ...
            -- warning
            local _groupId = dcsprotect.getGroupId(_unit)
            trigger.action.outTextForGroup(_groupId, "**[4YA] TRAINING NORMANDY PVE: Short Mission Briefing** \n\ \n\Capture all enemy bases within 7 hours, list in the breifing of all airports. You can use, TF-51d, Yak52 & Uh1h for transport\n\ \n\Comms menu -> F10 (Others) -> EWRS -> Requst Bogey Dope\n\ \n\Extra cap support available if needed: Comms menu -> F10 (Others) ->Extra Cap Support\n\ \n\SRS Main 124AM. Check the briefing for more info!:" .. _list, 15, true)

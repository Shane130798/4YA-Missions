    ...
    elseif _event.id == world.event.S_EVENT_TAKEOFF then
        ...
        local _unit = _event.initiator
         ...
         --   end
            ...
            -- warning
            local _groupId = dcsprotect.getGroupId(_unit)
            trigger.action.outTextForGroup(_groupId, "[4YA] TRAINING PVE 24/7: Short Mission Briefing** \n\ \n\Capture all enemy bases within 11 hours! \n\Server will restart when all bases are friendly. \n\Available: CTLD, Jtac, Side missions, Dynamic weather, Roadbases & SRS \n\ \n\Use radio menu & F10 to check tacans, waypoints, jtac and more\n\Join us on discord and read the briefing for more info Lalt+B!\n\Banned weapons:" .. _list, 15, true)

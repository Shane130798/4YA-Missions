...
csar.maxLives = 0 -- Maximum pilot lives
...
csar.messageTime = 15 -- Time to show the intial wounded message for in seconds

csar.loadDistance = 75 -- configure distance for pilot to get in helicopter in meters.
...
csar.max_units = 2 --number of pilots that can be carried
